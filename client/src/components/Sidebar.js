...
const Sidebar = () => {
  ...
  return (
    <div className='w-full h-full grid grid-cols-[48px,1fr] bg-slate-600'>
            <div className='bg-slate-400 w-12 h-full rounded-tr-lg rounded-br-lg py-5 text-slate-600 flex flex-col justify-between'>
                <div>
                    ...
                    <div title='add friend' onClick={()=>setOpenSearchUser(true)} className='w-12 h-12 flex justify-center items-center mt-1 cursor-pointer hover:bg-slate-200 rounded-full' >
                        <FaUserPlus size={20}/>
                    </div>
                </div>
